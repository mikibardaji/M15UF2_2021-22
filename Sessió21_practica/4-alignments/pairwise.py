...
# Alinear es fer parelles de lletres, les parelles es fan segons similitud i posició..
# Hi ha dos formes d'alinear (Alineamiento global/local)
# El global intenta alinear les dues seqüències de extrem a extrem. 
#     Exemple: GATAGATA alineat GATA--TA
# El alineament local alinea dues seqüències, a qualsevol posició. 
#     Exemple GATATA alineat GATA-A-- (la T no) s'utilitza quant les diferencies de longitud son grans
# Aligner object
# ---------------------------------------------------------------------
def check_aligner_parameters():

    # Create Aligner para sequences
